...
\begin{figure}[!htb]
\centering % For some reason I had to set this to .5 to get a reasonable size
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.5]{FalseNegativeHoverOver}
...
\begin{figure}[!b]
\centering
\includegraphics[scale=.8]{Diagnostic}
